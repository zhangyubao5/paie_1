...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    RootViewController *centerVC = [[RootViewController alloc] init];
    NSArray *name = @[@"1",@"2",@"3",@"4",@"5"];
    LeftTableViewController *leftVC = [[LeftTableViewController alloc] initWithString:name];
    ...
    [[AFNetworkReachabilityManager sharedManager] setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        ...
        {
            NSLog(@"无网");
            UIAlertView * aler = [[UIAlertView alloc]initWithTitle:@"错误" message:@"获取网络数据失败，请检查您的网络！" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
            [aler show];
        }
    }];
